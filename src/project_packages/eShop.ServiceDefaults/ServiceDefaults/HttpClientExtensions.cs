...
/// <summary>
/// Extension methods for HTTP client authentication behavior.
/// </summary>
public static class HttpClientExtensions
{
    /// <summary>
    /// Adds a delegating handler that forwards the current request access token to outgoing HTTP requests.
    /// </summary>
    /// <param name="builder">The HTTP client builder.</param>
    /// <returns>The same HTTP client builder for chaining.</returns>
